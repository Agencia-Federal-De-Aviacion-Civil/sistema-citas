...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('medicine_revaluation_initials', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('medicine_revaluations_id')->nullable();
            $table->foreign('medicine_revaluations_id')->references('id')->on('medicines')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('medicine_revaluation_initials');
    }
};
