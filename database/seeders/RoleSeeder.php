...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $role5 = Role::create(['name' => 'headquarters']);
        ...
        Permission::create(['name' => 'see.appointment.medicine', 'description' => 'The medicine admin could see history appoinment'])->syncRoles([$role2,$role5]);
        ...
        Permission::create(['name' => 'see.navigation.controller.sedes', 'description' => 'The Headquarters, you can see your scheduled appointments'])->syncRoles([$role5]);
        // PESTAÑAS
