<div>
    ...
    @if ($status == 0)
        @hasrole('super_admin|medicine_admin|super_admin_medicine|headquarters')
            <x-button
        ...
        @endhasrole
    @elseif($status == 1)
        @hasrole('super_admin|medicine_admin|super_admin_medicine|super_admin_medicine_two')
            <x-button
                wire:click="$emit('openModal', 'medicine.modals.schedule', {{ json_encode(['scheduleId' => $scheduleId, 'medicineId' => $medicineId]) }})"
    ...
    @elseif($status == 4)
        ...
        @hasrole('super_admin|medicine_admin|super_admin_medicine|user|super_admin_medicine_two')
