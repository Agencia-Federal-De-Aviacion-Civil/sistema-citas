<x-guest-layout>
    {{-- <section class="min-h-screen bg-cover "
        style="background-image: url('{{ asset('images/citas_internet.jpg') }}')">
            ...
            <div class="container flex flex-col flex-1 px-6 py-12 mx-auto">
                <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
                    <div class="flex items-center justify-center opacity-80">
                        <img class="lg:w-60 lg:h-35 w-40 h-30 mr-2" src="{{ asset('images/isologo_AFAC_white.png') }}"
                            alt="logo">
                    </div>
                    <div class="text-white lg:w-1/2 lg:mx-6">
                        <h1 class="text-[#BC955C] text-5xl">Bienvenido</h1>
                        <h1 class="text-2xl font-semibold capitalize lg:text-3xl">SISTEMA GENERAL DE CITAS DE LA AFAC
                        </h1>
                        <p class="max-w-xl mt-6 lg:text-lg text-md">

                        </p>
                    </div>
                    <div class="lg:w-3/5 lg:mx-16">
                        <div
                            class="w-full px-8 py-8 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-xl">
                            <h3 class="mb-4 text-xl font-semibold sm:text-center sm:mb-6 sm:text-2xl">
                                ACCESO
                            </h3>
                            <x-jet-validation-errors class="mb-4" />
                            ...
                            <form method="POST" class="mt-6" action="{{ route('login') }}">
                                ...
                                <div
                                    ...
                                    <a href="{{ route('register') }}"
                                        class="mx-2 text-md font-bold text-blue-500 dark:text-blue-400 hover:underline"><span
                                            class="text-md text-gray-600 dark:text-gray-200">SI NO TIENES CUENTA?
                                        </span> REGISTRATE</a>
                                </div>
                            </form>
                        </div>
