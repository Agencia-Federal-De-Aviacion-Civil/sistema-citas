                ...
                @canany(['super_admin.see.tabs.navigation'])
                    <div x-data="{ roleuser: @entangle('privileges') }">
                        ...
                        <div class="mt-4"
                            ...
                            <label for="systems"
                                class="block text-sm font-medium text-gray-900 dark:text-white">RESPONSABLE DE
                                LA
                                SEDE:</label>
                    ...
                    <div class="grid xl:grid-cols-2 xl:gap-4 grid-cols-1 py-2 space-x-4">
                        <div class="flex flex-col">
                            <div class="mt-1 relative z-auto w-full group">
                                <x-datetime-picker wire:model.lazy="start_date" label="FECHA DE INICIAL"
                                    without-time="false" placeholder="INGRESAR..." display-format="DD-MM-YYYY" />
                            </div>
                        </div>
                ...
                <div x-data="{ open: false }">
                    ...
                    <ul x-show="open" x-transition:enter="transition ease-out duration-300"
                        ...
                        <div class="grid xl:grid-cols-3 xl:gap-6">
                            ...
                            <div class="mt-4 relative w-full group">
                                <x-input class="uppercase" wire:model.lazy="rfc_participant" label="INGRESE RFC"
                                    placeholder="ESCRIBE..." />
                            </div>
