                ...
                <div class="container flex flex-col flex-1 px-6 py-12 mx-auto">
                    <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
                        ...
                        <div class="mt-8 lg:w-9/12 lg:mx-6">
                            <div
                                class="w-full px-8 py-10 mx-auto bg-white shadow-2xl rounded-xl dark:bg-gray-900 lg:max-w-6xl">
                                ...
                                <div x-data="{ enabled: @entangle('enabled'), }">
                                    ...
                                    <div class="mt-8 grid md:grid-cols-2 md:gap-6">
                                        <div class="relative mb-3 w-full group">
                                            <x-input wire:model.blur="curp" label="INGRESA TU CURP"
                                                x-mask="******************" x-bind:disabled="enabled"
                                    ...
                                    <div x-show="!enabled">
                                        <div class="flex items-center justify-center opacity-80 animate-bounce mt-12">
                                            <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="100"
                                                height="100" viewBox="0 0 1280.000000 1280.000000"
                                    ...
                                    <div x-show="enabled">
                                        ...
                                        @enderror --}}
                                            ...
                                            <div class="relative mb-6 w-full group">
                                                <x-input class="uppercase" wire:model.lazy="apParental"
                                        ...
                                        @enderror --}}
                                            ...
                                            <div class="relative mb-6 w-full group">
                                                <x-input class="uppercase" wire:model.lazy="apMaternal"
                                        ...
                                        <div class="mt-2 grid md:grid-cols-3 md:gap-6">
                                            <div class="relative mb-6 w-full group">
                                                <x-input class="uppercase" wire:model.lazy="street"
                                                    label="INGRESE LA CALLE" placeholder="ESCRIBE..." />
                                            </div>
                                            <div class="relative mb-6 w-full group">
                                                <x-input class="uppercase" wire:model.lazy="nInterior"
                                                    label="NÚMERO INTERIOR" placeholder="ESCRIBE..." />
                                            </div>
                                            <div class="relative mb-6 w-full group">
                                                <x-input class="uppercase" wire:model.lazy="nExterior"
                                                    label="NÚMERO EXTERIOR" placeholder="ESCRIBE..." />
                                            </div>
                                        </div>
                                        <div class="mt-6 grid md:grid-cols-3 md:gap-6">
                                            <div class="relative mb-6 w-full group">
                                            ...
                                            <div class="relative mb-6 w-full group">
                                                <x-input class="uppercase" wire:model.lazy="delegation"
                                                    label="LOCALIDAD" placeholder="ESCRIBE..." />
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid md:grid-cols-2 md:gap-6">
                                            <div class="relative z-0 mb-6 w-full group">
                                                <x-input class="pr-28" label="CORREO ELECTRÓNICO"
                                                    wire:model.lazy="email" placeholder="INGRESE..." />
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-4 grid md:grid-cols-2 md:gap-6">
                                            <div class="relative w-full mb-3 group">
                                                <x-input class="uppercase" wire:model.live="rfc_company_participant"
                                                    x-mask="*************" x-bind:disabled="!enabled"
                                                    label="RFC DE LA EMPRESA" placeholder="INGRESE..." />
                                            </div>
                                            <div class="relative w-full mb-3 group">
                                        ...
                                        <div class="flex p-4 mb-4 mt-2 text-sm text-sky-900 rounded-lg bg-sky-50"
                                            role="alert">
        ...
        <script>
            document.addEventListener('livewire:init', () => {
                ...
                Livewire.on('updated-state', (options) => {
                    ...
                    const formattedOptions = options[0].map(option => ({
                ...
                const slimSelectLocation = new SlimSelect({
                ...
                Livewire.on('updated-location', (options) => {
                    const defaultSelect = [{
                        'placeholder': true,
                        'text': 'SELECCIONE...'
                    }];
                    const formattedOptions = options[0].map(option => ({
                        text: option.name_location,
                        value: option.id + ',' + option.name_location
                    }));
                    const formattedConcatOptions = defaultSelect.concat(formattedOptions);
                    slimSelectLocation.setData(formattedConcatOptions);
                });

                const slimSelectCountry = new SlimSelect({
