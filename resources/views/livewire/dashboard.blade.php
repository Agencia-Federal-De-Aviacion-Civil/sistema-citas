                            ...
                            <div tabindex="-1"
                                ...
                                <div class="relative w-full max-w-3xl max-h-full overflow-auto">
                                    ...
                                    {{-- <div class="relative bg-white rounded-lg shadow dark:bg-gray-700"> --}}
                                        ...
                                        <div
                                        class="inline-block px-4 pt-5 pb-4 overflow-hidden text-justify align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full sm:p-6">
                                        <div class='w-full max-w-full px-10 py-8 mx-auto bg-gray-100 rounded-lg shadow-xl'>
                                            <div class='max-w-full mx-auto space-y-6'>
                                                <div class="flex">
                                                    <img src="https://citas-medicina.afac-avciv.com/images/AFAC1.png"
                                                        class='h-16' />
                                                    <p class="text-right text-2xl mt-4"><b class="text-sky-800">AVISO</b>
                                                        {{-- DE REGISTRO DE TRAMITE --}}
                                                    </p>
                                                </div>
                                                <p class='text-gray-600'>
                                                    Estimado usuario, su ultima evaluación médica para la clase seleccionada ha resultado como
                                                        <b>'NO APTO'</b>. Para poder agendar una nueva cita de revaloración, es necesario que la
                                                            Dirección Médica de la AFAC
                                                            genere la autorización correspondiente, le sugerimos se ponga en contacto al
                                                            siguiente correo electrónico:  evaluacion.medica@afac.gob.mx. para iniciar su proceso.
                                                            Agradecemos su comprensión .

                                                </p>
                                                <div class="pt-4 flex items-center space-x-12">
                                                    <x-button
                                                            @click="showModal = false" label="ACEPTAR"
                                                        class="flex justify-center items-center w-full text-gray-600 px-3 bg-gray-200 py-2 text-gray-100 rounded-md focus:outline-none hover:bg-gray-300"
                                                        />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                        <div class="p-6 text-center">
                                            ...
                                            <div class="mt-5 sm:flex sm:items-center sm:justify-between">
                                                <a href="https://www.gob.mx/afac/acciones-y-programas/citas-para-la-evaluacion-medica"
                                                    target="_blank"
                                                    class="text-sm text-blue-500 hover:underline">Mayor
                                                    información</a>
