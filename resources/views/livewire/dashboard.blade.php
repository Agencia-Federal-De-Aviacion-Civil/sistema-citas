                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    <div class="p-6 text-center">
                                        ...
                                        <div class="mt-5 sm:flex sm:items-center sm:justify-between">
                                            <a href="https://www.gob.mx/afac/acciones-y-programas/citas-para-la-evaluacion-medica" target="_blank" class="text-sm text-blue-500 hover:underline">Mayor información</a>
