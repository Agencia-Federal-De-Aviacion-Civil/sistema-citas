                            ...
                            <div class="relative w-full max-w-3xl max-h-full overflow-auto">
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    <div class="p-6 text-center">
                                        <div x-cloak x-data="{ trasnport: '', step: '1' }">
                                            <div x-cloak x-show="step == '1'">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                                                    ¿EN QUE TRASPORTE VAS A REALIZAR TU CITA?</h3>

                                                <x-select x-ref="trasnport" placeholder="Seleccione el trasporte..">
                                                    <x-select.option label="AUTOTRANSPORTE" value="1" />
                                                    <x-select.option label="FERROVIARIO" value="2" />
                                                    <x-select.option label="MARÍTIMO" value="3" />
                                                </x-select>
                                            </div>
                                            <div x-cloak x-show="step == '2'">
                                                            ...
                                                            @foreach ($stategrup as $stategrups)
                                                                <li class="relative border-b border-gray-200"
                                                                    ...
                                                                    <div class="relative overflow-hidden transition-all max-h-0 duration-700"
                                                                        ...
                                                                        x-bind:style="selected == 1 ? 'max-height: ' + $refs
                                                                            .container1
                                                                            .scrollHeight + 'px' : ''">
                                                                        <div class="p-6">
                                                ...
                                                <div class="mt-5 sm:flex sm:items-center sm:justify-between">
                                                    <x-button x-on:click="step = '1'" icon="arrow-circle-left"
                                                        primary label="ANTERIOR" class="px-4" />
                                                    <div class="sm:flex sm:items-center ">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <x-button wire:click.prevent="selected"
                                                                right-icon="arrow-circle-right" primary
                                                                label="CONTINUAR" />
