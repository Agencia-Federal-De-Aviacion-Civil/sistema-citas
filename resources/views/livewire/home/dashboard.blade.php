<div>
    <div class="relative py-6 lg:py-4">
        ...
        <div
            ...
            <div>
                <h4 tabindex="0" class="focus:outline-none text-2xl font-bold leading-tight text-white">BIENVENIDO AL
                            ...
                            <div
                                ...
                                <div class="overflow-hidden bg-cover cursor-pointer lg:h-48 md:h-36 w-full object-cover object-center group"
                                    ...
                                    <div
                                        ...
                                        <h2 class="mt-4 text-2xl font-semibold text-white capitalize">NUEVA CITA</h2>
