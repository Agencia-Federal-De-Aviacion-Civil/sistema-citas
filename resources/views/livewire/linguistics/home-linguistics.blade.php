                            ...
                            <div class="flex flex-wrap w-full">
                                <div class="lg:w-full md:w-full md:pr-10 md:py-6">
                                    <div class="flex relative pb-6">
                                        ...
                                        <div class="flex-shrink-0 w-10 h-10 rounded-full bg-sky-700 inline-flex items-center justify-center text-white relative z-10">
                                            ...
                                            <div class="grid xl:grid-cols-4 xl:gap-6">
                                                <div class="mt-1 relative z-0 w-full group">
                                                    <div class="relative z-0 w-full mb-6 group">
                                                        <x-input x-ref="refnumber" wire:model.lazy="reference_number" label="REFERENCIA DE PAGO" placeholder="INGRESE..." />
                                                    </div>
                                                </div>
                                                <div class="mt-1 relative z-auto w-full group">
                                                    <x-input wire:model.lazy="pay_date" id="fecha-pago" label="FECHA DE PAGO" placeholder="INGRESE..." readonly />
                                                </div>
                                                <div class="mt-1 relative z-auto w-full group grid-cols-2 xl:col-span-2">
                                                    <label for="small" class="block text-base font-medium text-gray-900 dark:text-white">ADJUNTA
                                                        EL COMPROBANTE DE PAGO
                                                    </label>
                                                    <input type="file" wire:model="name_document" x-ref="file" @change="fileName = $refs.file.files[0].name" class="block w-full border border-gray-200 shadow-sm rounded-md text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 file:bg-transparent file:border-0 file:bg-gray-100 file:mr-4 file:py-2.5 file:px-4 dark:file:bg-gray-700 dark:file:text-gray-400">
                                            ...
                                            <div class="grid md:grid-cols-3 md:gap-6">
                                                <div class="relative z-auto w-full mb-6 group">
                                                    <x-select wire:model.lazy="type_exam_id" label="TIPO DE EVALUACIÓN" placeholder="Seleccione...">
                                                        ...
                                                        <x-select.option label="{{ $exam->name }}" value="{{ $exam->id }}" /> @endforeach
                                                    </x-select>
                                                </div>
                                                <div class="relative z-auto w-full mb-6 group">
                                            ...
                                            <div class="grid xl:grid-cols-3 xl:gap-6">
                                                ...
                                                <div class="text-base relative z-auto w-full mb-2 group">
                                                    <x-select wire:model.lazy="headquarters_id" label="SEDE" placeholder="Seleccione...">
                                                        ...
                                                        <x-select.option label="{{ $headquartersQuery->headquarterUser->name }}" value="{{ $headquartersQuery->id }}" /> @endforeach
                                                    </x-select>
                                                </div>
                                                <div class="text-base relative z-auto w-full mb-2 group">
                                                    <x-input x-ref="reservedate" wire:model.lazy="dateReserve" id="selector-fecha" label="FECHA Y HORA DE CITA" placeholder="INGRESE..." readonly />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div x-show="reservedate > '0'" class="flex relative">
                                        ...
                                        <div class="flex-grow pl-4">
                                            <div class="">
                                                <x-button wire:click.prevent="save" label="GUARDAR" blue right-icon="archive" />
