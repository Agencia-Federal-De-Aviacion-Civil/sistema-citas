...
<body class="bgsize">
    ...
    <div>
        ...
        <div class="codigoqr">
            <img src="http://chart.googleapis.com/chart?chs=70x70&chld=L|0&cht=qr&chl={{ route('afac.homeQr', $medicineId) }}"
        ...
        <div style="padding-top:1%;font-size:17px">
            <ol style="text-align: justify">
                ...
                <p style="padding-left:3%">D) Prueba de detección de sustancias psicoactivas en orina, de 5 reactivos
                    (Cocaína, Cannabinoides, Opiaceos, Anfetaminas y Benzodiazepinas).</p>
