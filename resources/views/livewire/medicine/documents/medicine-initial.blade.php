...
<body class="bgsize">
    <div>
        ...
        <div class="cuadrado-2">
            <p>Folio de cita: <b>{{ $printQuery->id }}</b></p>
        </div>
        <table class="info">
            <tr>
        ...
        <div style="padding-top:2%">
            <label style="text-align: justify;font-size:18px" for="">Estimado usuario, con el fin de facilitar el procedimiento de registro y apoyarle en el proceso de su EVALUACIÓN MÉDICA, le mostramos los siguientes 
                <b>requisitos indispensables</b> para presentarse a su cita; es indispensable que acuda con los siguientes documentos <u>original y
        ...
        <div class="mt-4 mx-4 text-justify">
            ...
            <ol>
                ...
                <li>En caso de haber sido diagnosticado con alguna(s) enfermedad(es) crónica(s) (enfermedades cardiacas, respiratorias, hipertiroidismo, etc.), presentar un resumen clínico expedido por su médico tratante de especialidad acorde a la patología y estudios 
                    <b>adicionales (ver Anexo)</b> con vigencia no mayor a 2 meses para acreditar el estado actual de salud.
                </li>
                <li>En caso de presentar disminución en la agudeza visual, deberá presentarse con lentes de armazón o de contacto con graduación actualizada. Si alterna el uso de ambos, deberá presentarlos. Para el personal de pilotos en caso de usar lentes de contacto deberá acudir con sus lentes de armazón de repuesto.
                </li>
                ...
                <li>Acudir con los estudios de laboratorio que a continuación se enlistan, los cuales deberán
                    ...
                    <p style="padding-left:3%">F) En el caso del examen médico inicial, presentar radiografía de tórax posteroanterior, y para el examen médico de renovación como a continuación se indica:</p>
