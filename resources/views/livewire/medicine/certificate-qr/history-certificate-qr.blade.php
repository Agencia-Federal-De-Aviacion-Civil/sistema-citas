<div>
    <div class="relative py-6 lg:py-4">
        ...
        <div
            ...
            <div>
                <h4 tabindex="0" class="focus:outline-none text-2xl font-bold leading-tight text-white">Historial de
                    Certificados</h4>
    ...
    <div class="py-12">
        <div class="container mx-auto px-4 py-4 bg-white shadow-xl sm:rounded-lg">
            <div class="mt-12 max-w-7xl mx-auto sm:px-6 lg:px-8">
                @livewire('medicine.certificate-qr.tables.history-certificate-qr-table')
            </div>
        </div>
    </div>
</div>
