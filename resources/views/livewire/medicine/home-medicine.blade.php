<div>
    @if ($isDisabled)
        LAMENTAMOS LAS MOLESTIAS, POR EL MOMENTO NO SE PUEDEN AGENDAR CITAS, INTENTALO MAS TARDE
    @else
                                        ...
                                        <div class="lg:w-full md:w-full md:pr-10 md:py-6">
                                            ...
                                            <div x-show="fileName != ''" class="flex relative pb-6">
                                                ...
                                                <div class="flex-grow pl-4">
                                                    ...
                                                    <select id="small" x-ref="tipoExamen"
                                                        wire:model.lazy="type_exam_id" wire:change="resetQuestions()"
