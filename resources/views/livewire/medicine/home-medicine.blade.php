                                ...
                                <div class="flex flex-wrap w-full">
                                    <div class="lg:w-full md:w-full md:pr-10 md:py-6">
                                        ...
                                        <div x-show="tipoExamen ==='3'" class="flex relative pb-6">
                                            ...
                                            <div class="flex-grow pl-4">
                                                <label for="small"
                                                    class="block mb-2 text-base font-medium text-gray-900 dark:text-white">ADJUNTAR LA AUTORIZACIÓN POR PARTE DE LA AGENCIA FEDERAL DE AVIACIÓN CIVIL</label>
                                                    <label for="file-input" class="sr-only">Adjunta el
                                                        comprobante</label>
                                        ...
                                        {{-- paso2 --}}
                                        <div x-show="tipoExamen ==='1'||typerevalora==='1'" class="flex relative pb-6">
                                            <div class="h-full w-10 absolute inset-0 flex items-center justify-center">
                                                <div class="h-full w-1 bg-gray-200 pointer-events-none"></div>
                                            </div>
                                            <div
                                        ...
                                        <div x-show="tipoExamen === '2' || typerevalora==='2'" class="flex relative pb-6">
                                            <div class="h-full w-10 absolute inset-0 flex items-center justify-center">
                                                <div class="h-full w-1 bg-gray-200 pointer-events-none"></div>
                                            </div>
                                            <div
