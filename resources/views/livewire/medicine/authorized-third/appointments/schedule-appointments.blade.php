                        ...
                        <div class="container flex flex-col px-4 py-12 mx-auto text-center">
                            <div class="grid xl:grid-cols-6 xl:gap-6 py-2">
                                ...
                                <div class="inline-flex w-full mt-6 sm:w-auto">
                                    <x-button wire:click.prevent="searchcurp()"
                                    label="VALIDAR" blue right-icon="search" />
                                    </button>
                                            ...
                                            <div>
                                                ...
                                                <ol class="mt-4 grid grid-cols-3 text-sm font-medium text-gray-500">
                                                    <li class="flex items-center justify-start sm:gap-1.5"
                                                        ...
                                                        <span class="hidden sm:inline"> Verifica los datos </span>
                                                    ...
                                                    <li class="flex items-center justify-end sm:gap-1.5"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                            class="w-6 h-6" :class="{ 'text-green-600': steps == 4 }">
                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                        ...
                                                        <li
                                                            ...
                                                            <div class="flex items-center pl-3">
                                                                <x-radio id="right-labelF" label="FEMENINO"
                                                                    value="FEMENINO" wire:model.defer="genre" />
                                                            </div>
                                                        </li>
                                                        <li
                                                            class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
                                                            <div class="flex items-center pl-3">
                                                                <x-radio id="right-labelM" label="MASCULINO"
                                                                    value="MASCULINO" wire:model.defer="genre" />
                                                            </div>
                                                        </li>
                                                    </ul>
                                                    <div class="relative mb-6 w-full group">
                                                ...
                                                <div class="grid md:grid-cols-2 md:gap-6">
                                                    ...
                                                    <div class="relative mb-6 w-full group">
                                                        <x-input class="pr-28" type="password"
                                                            label="CONFIRMAR CONTRASEÑA" wire:model.lazy="password"
                                                            placeholder="INGRESE..." />
                                                    </div>
                                                </div>
