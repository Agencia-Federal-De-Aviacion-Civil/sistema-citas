            ...
            <div class="mt-4 text-center">
                ...
                <div x-data="{ selectedOption: '' }">
                    ...
                    <div x-show="selectedOption == 2">
                        <div class="mt-4">
                            <x-textarea wire:model="comment_cancelate" label="MOTIVO" placeholder="ESCRIBE..." />
                        </div>
                    </div>
                    @if ($this->status == 2)
                        <div class="mt-4">
                    ...
                    <div x-show="selectedOption == 4">
                        <div class="mt-4">
                            <x-textarea wire:model="comment" label="MOTIVO" placeholder="ESCRIBE..." />
                        </div>
                    </div>
                    <div x-show="selectedOption != 2">
                        @if ($this->status == 4)
                            <div class="mt-4">
                                <x-textarea wire:model="comment" label="MOTIVO" placeholder="ESCRIBE..." disabled />
                            </div>
                        @endif
                    </div>
                </div>
