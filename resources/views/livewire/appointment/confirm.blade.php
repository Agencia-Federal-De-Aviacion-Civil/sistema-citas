                ...
                <div class="">
                    ...
                    <div class="flex flex-wrap sm:mx-auto sm:mb-4 -mx-2">
                        <div class="sm:w-1/2 w-full">
                            <div class="rounded flex p-0 h-full items-center">
                                ...
                                <p class="text-xl text-sky-800 font-semibold"> 00051551</p>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-wrap sm:mx-auto sm:mb-4 -mx-2">
                        <div class="sm:w-full w-full">
                            <div class="rounded flex p-0 h-full items-center">
                                ...
                                <p class="text-lg title-font font-normal">Tramite:
                                <p class="text-xl font-semibold">Permiso para piloto comercial de aeronave de ala fija
                                </p>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="grid xl:grid-cols-2 xl:gap-6">
                            <div class="sm:w-full w-full">
                                <div class="rounded flex p-0 h-full items-center">
                                    ...
                                    <p class="text-xl font-semibold">{{ $appointment->appointmentTypeExam->name }}</p>
                                    </p>
                                </div>
                            </div>
                            <div class="sm:w-full w-full">
                        ...
                        <div class="grid xl:grid-cols-2 xl:gap-52">
                            <div class="sm:w-full w-full">
                                <div class="rounded flex p-0 h-full items-center">
                                    ...
                                    <p class="text-xl font-semibold">2022-07-28</p>
                                    </p>
                                </div>
                            </div>
                            <div class="sm:w-full w-full">
                                <div class="rounded flex p-0 h-full items-center">
                                    ...
                                    <p class="text-xl font-semibold">18:00</p>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="grid xl:grid-cols-2 xl:gap-24">
                            <div class="sm:w-full w-full">
                                <div class="rounded flex p-0 h-full items-center">
                                    ...
                                    <p class="text-xl font-semibold">Cancún Quintana Roo</p>
                                    </p>
                                </div>
                            </div>
                            <div class="sm:w-full w-full">
                    ...
                    <div class="p-y-6 px-6 flex flex-wrap sm:mx-auto sm:-mb-2 -mx-2">
                        <div class="grid xl:grid-cols-2 xl:gap-24">
                            <div class="sm:w-full w-full">
                                <div class="rounded flex p-0 h-full items-center">
                                    <p class="text-lg title-font font-normal">Av. Nichupté, Manzana 10, Edificio Laura,
