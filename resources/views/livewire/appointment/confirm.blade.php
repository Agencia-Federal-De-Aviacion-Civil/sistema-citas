            ...
            <div
                ...
                <div class="">
                    ...
                    @foreach ($appointmentInfo as $appointment)
                            ...
                            <div class="flex flex-wrap sm:mx-auto sm:mb-4 -mx-2">
                                <div class="sm:w-full w-full">
                                    <div class="rounded flex p-0 h-full items-center">
                                        ...
                                        <p class="text-xl font-semibold">Permiso para piloto comercial de aeronave de
                                            ala fija
                                        </p>
                                        </p>
                                    </div>
                                ...
                                <div class="grid xl:grid-cols-2 xl:gap-24">
                                    <div class="sm:w-full w-full">
                                        <div class="rounded flex p-0 h-full items-center">
                                            ...
                                            <p class="text-xl font-semibold">{{$userAppointment->appointmentSuccess[0]->successHeadquarter->name}}</p>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="sm:w-full w-full">
                        ...
                        @endif
                    @endforeach
                    <a href="{{route('download')}}">IMPRIMIR CITA</a>
