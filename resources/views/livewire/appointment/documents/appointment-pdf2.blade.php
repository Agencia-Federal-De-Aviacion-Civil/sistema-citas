        ...
        <div class="mt-4 mx-7 text-justify ">
            ...
            <ol class="">
                ...
                <li>Acudir con los estudios de laboratorio que a continuación se enlistan, los cuales deberán realizarse
                    ...
                    <p tyle="padding-left:10%">c) Examen General de Orina</p>
                    <p tyle="padding-left:10%">d) Radiografía de Tórax Posteroanterior de la siguiente manera:</p>
                    <p tyle="padding-left:14%">1. Clase I – cada 3 años.</p>
                    <p tyle="padding-left:14%">2. Clase II – cada 4 años.</p>
                    <p tyle="padding-left:14%">3. Clase III – cada 3 años.</p>
                    <p tyle="padding-left:14%">4. O antes a indicación de su médico examinador..</p>
                </li>
