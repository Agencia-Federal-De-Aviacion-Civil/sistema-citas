                                ...
                                @foreach ($headquarters_afac as $headquarter_afac)
                                    <tr class="text-gray-700 dark:text-gray-100">
                                        ...
                                        <td
                                            ...
                                            {{ $headquarter_afac->headquarterMedicineReserve->where('dateReserve', $date1_afac1)->whereIn('status', ['0', '1', '4'])->count() }}
                                        </td>
                                        <td
                                            class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                            {{ $headquarter_afac->headquarterMedicineReserve->where('dateReserve', $tomorrow_afac1)->whereIn('status', ['0', '1', '4'])->count() }}
                                        </td>
                                        <td
                                            class="border-t-0 px-4 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                        ...
                                        <td
                                            ...
                                            <div class="flex items-center">
                                                <span
                                                    class="mr-2">{{ $headquarter_afac->headquarterMedicineReserve->count() > 0 ? round(($headquarter_afac->headquarterMedicineReserve->count() * 100) / $registradas_afac1, 1) : '0' }}%</span>
                                                <div class="relative w-full">
                                                    <div class="overflow-hidden h-2 text-xs flex rounded bg-blue-200">
                                                        <div style="width:{{ $headquarter_afac->headquarterMedicineReserve->count() > 0 ? ($headquarter_afac->headquarterMedicineReserve->count() * 100) / $registradas_afac1 : '0' }}%"
