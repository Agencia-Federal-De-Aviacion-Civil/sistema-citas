<div>
    ...
    <div class="grid grid-cols-2 gap-2">
        ...
        <a title="FORMATO DE PAGO"
            class="underline hover:no-underline" href="#" wire:click='documentDownload({{ $id_document }})'>
            ...
            <a title="FORMATO DE AUTORIZACIÓN" class="underline hover:no-underline" href="#"
