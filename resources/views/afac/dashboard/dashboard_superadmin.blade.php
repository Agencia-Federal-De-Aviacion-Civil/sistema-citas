                        ...
                        <div class="bg-gray-100 text-gray-500 rounded shadow-xl py-5 px-5 w-full sm:w-full md:w-full lg:w-full"
                            ...
                            <div class="relative overflow-hidden transition-all duration-500" x-ref="card"
                                ...
                                <div>
                                    ...
                                    <div
                                        class="-mt-2 grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                                        <div class="flex items-start p-2">
                                            <div
                                                class="flex h-12 w-12 items-center justify-center rounded-full border border-gray-100 bg-gray-50">
                                                <span href="#blue"
                                                    class="block w-3 h-3 bg-gray-500 rounded-full"></span>
                                            </div>
                                        ...
                                        <div class="flex items-start p-2">
                                            <div
                                                ...
                                                <span href="#blue"
                                                    class="block w-3 h-3 bg-blue-800 rounded-full"></span>
                                            </div>
                                        ...
                                        <div class="flex items-start p-2">
                                            <div
                                                class="flex h-12 w-12 items-center justify-center rounded-full border border-blue-100 bg-blue-50">
                                                <span href="#blue"
                                                    class="block w-3 h-3 bg-blue-500 rounded-full"></span>
                                            </div>
                                            <div class="ml-4">
                                        ...
                                        <div class="flex items-start p-2">
                                            <div
                                                ...
                                                <span href="#blue"
                                                    class="block w-3 h-3 bg-red-500 rounded-full"></span>
                                            </div>
