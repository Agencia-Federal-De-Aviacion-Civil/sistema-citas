...
class HomeMedicineAfac extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.medicine.medicine-afac.home-medicine-afac' ,compact('date2_afac1','now_afac1','registradas_afac1','porconfir_afac1','validado_afac1','pendientes_afac1','porpendientes_afac1','canceladas_afac1','reagendado_afac1','porcanceladas_afac1','porreagendado_afac1','headquarters_afac1'));
    }
}
