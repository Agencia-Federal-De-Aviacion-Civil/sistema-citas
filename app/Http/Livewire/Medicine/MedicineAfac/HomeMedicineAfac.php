...
class HomeMedicineAfac extends Component
{
    ...
    public function render()
    {
        ...
        // $pendientes_afac = $appointment_afac1->where('status', '0')->sum('count');
        // $porpendientes_afac = $registradas_afac != 0 ? round($appointment_afac1->where('status', '0')->sum('count') * 100 / $registradas_afac, 0) : 0;
        // $canceladas_afac = $appointment_afac1->whereIn('status', ['2', '3', '5'])->sum('count');
        ...
        return view('livewire.medicine.medicine-afac.home-medicine-afac' , compact('date2_afac1','now_afac1','registradas_afac1','porconfir_afac1','validado_afac1'));
    }
}
